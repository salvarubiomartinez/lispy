...
(DEFUN LENGTH (L) (COND ((EQ NIL L) 0) (T (PLUS 1 (LENGTH (CDR L))))))
...
(DEFUN RANGE (INIT FINAL) (COND ((EQ INIT FINAL) (LIST FINAL)) (T (CONS INIT (RANGE (PLUS 1 INIT) FINAL)))))
(defun map (fun lis) (reduce (macro (x y) (append y (list (fun x) ))) lis nil))
(defun lengthrecur (lengthlist) (reduce (macro (x y) (plus 1 y)) lengthlist 0))
